...
class GenerateRandomReviewsCommand extends Command
{
    ...
    protected function execute(InputInterface $input, OutputInterface $output): int
    {
        ...
        foreach ($books as $book) {
            ...
            for ($i = 0; $i < $noticeCount; $i++) {
                ...
                $notice->setRate(rand(1, 5));

                $notice->setReview($sampleComments[array_rand($sampleComments)]);
        ...
        $output->writeln('Reviews générées avec succès !');
